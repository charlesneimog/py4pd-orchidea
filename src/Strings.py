...
def orchideaContrabass(note, dyn, orchideaNumber):
    '''
    Orchidea Contrabass: 
        Args:
            note: string "A4"
    ...
    if orchideaNumber == 1:
        ...
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/artificial_harmonic/' + 'Cb-art_harm-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/artificial_harmonic_tremolo/' + 'Cb-art_harm_trem-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/behind_the_bridge/' + 'Cb-behind_bridge-N-N*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        dynamics = ['mf']
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/col_legno_battuto/' + 'Cb-legno_batt-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        dynamics = ['mf']
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/col_legno_tratto/' + 'Cb-legno_tratto-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        dynamics = ['pp', 'mf', 'ff']
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/ordinario/' + 'Cb-ord-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be ff.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/pizzicato_bartok/' + 'Cb-pizz_bartok-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be pp, mf or ff.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/pizzicato_l_vib/' + 'Cb-pizz_lv-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be pp, mf or ff.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/pizzicato_secco/' + 'Cb-pizz_sec-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be fp or f.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/sforzato/' + 'Cb-sfz-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be mf.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/sul_ponticello/' + 'Cb-pont-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be mf.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/sul_ponticello_tremolo/' + 'Cb-pont_trem-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be mf.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/sul_tasto_tremolo/' + 'Cb-tasto_trem-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be mf.")
            return None 
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass/tremolo/' + 'Cb-trem-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be pp, mf or ff.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass+sordina/ordinario/' + 'Cb+S-ord-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
        ...
        if dyn not in dynamics:
            pd.error("Wrong dynamic, must be mf.")
            return None
        pathname = os.path.join(ORCHIDEASOL_PATH, 'Strings/Contrabass+sordina/tremolo/' + 'Cb+S-trem-' + note + '-' + dyn + '*')
        pathnames = glob.glob(pathname)
        if pathnames == []:
            pd.error("Sample not found.")
            return None
